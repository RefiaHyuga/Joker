 ...
 * @author Mouse
 */
public class jFContenido extends javax.swing.JFrame {

    //dirección de la carpeta de archivos HTML e imagenes
    private String help_path = System.getProperty("user.dir") + "\\src\\Help\\";
    
    /** Constructor */
    public jFContenido() {
        initComponents();
        
        setTitle("Contenido de Joker");
        ...
        jEditorPane1.setText( readFile("introduccion") );//lee el primer archivo
        ...
        render.setLeafIcon(new ImageIcon(getClass().getResource("../Imagenes/sheet.jpg")));        
        render.setOpenIcon(new ImageIcon(getClass().getResource("../Imagenes/open.jpg")));
        render.setClosedIcon(new ImageIcon(getClass().getResource("../Imagenes/close.jpg")));
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jFContenido.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jFContenido().setVisible(true);
            }
        });
    }
